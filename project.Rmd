...
author: "Risshi Naaavaal, Caleb Adhikari, and Jonas Lee"
fontsize: 12pt
geometry: margin=1in
urlcolor: black
output: pdf_document
...
bp3 <- ggplot(q3_summary, aes(x = health_exp_greater_than_5, y = Mean_Life_Expectancy, fill =
  health_exp_greater_than_5)) +
    geom_bar(stat = "identity", alpha = 0.8, width = 0.5) +
    geom_text(aes(label = round(Mean_Life_Expectancy, 2)), vjust = -0.5, size = 3.5) +
    labs(title = "Mean Life Expectancy by Health Expenditure Level",
         subtitle = "Countries with Below Median GDP per Capita",
         x = NULL,
         y = "Life Expectancy (years)") +
