...
- Lastly, we will observe countries that have a below median GDP per capita and determine whether, from that set of countries, countries that spend more than 5% on health expenditure have a greater life expectancy than countries that spend less than 5% on health expenditure.
...
-Link to GitHub Repository: https://github.com/RisshiN24/3080-project
